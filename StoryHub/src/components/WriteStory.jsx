...
const WriteStory = () => {
  ...
  const fetchDrafts = async () => {
    try {
      const response = await fetch('https://storyhub.freewebhostmost.com/getDrafts.php');
  ...
  const saveDraft = async () => {
    try {
      const response = await fetch('https://storyhub.freewebhostmost.com/saveDraft.php', {
        method: 'POST',
        headers: {
  ...
  const publishStory = async () => {
    ...
    try {
      const response = await fetch('https://storyhub.freewebhostmost.com/publishStory.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const loadDraft = async (draftId) => {
    try {
      const response = await fetch(`https://storyhub.freewebhostmost.com/getDraft.php?id=${draftId}`);
      const data = await response.json();
      setStory(data);
    } catch (error) {
  ...
  const deleteDraft = async (draftId) => {
    if (window.confirm('Are you sure you want to delete this draft?')) {
      try {
        const response = await fetch(`https://storyhub.freewebhostmost.com/deleteDraft.php?id=${draftId}`, {
          method: 'DELETE'
        });
        const data = await response.json();
        if (data.success) {
